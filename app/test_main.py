...
class TestCanAccessGooglePage(unittest.TestCase):
    ...
    def test_valid_url_and_internet_available(
        self, mock_int: unittest.mock.Mock, mock_url: unittest.mock.Mock
    ) -> None:
    ...
    @patch("app.main.valid_google_url")
    @patch("app.main.has_internet_connection")
    def test_valid_url_and_internet_not_available(
        self, mock_int: unittest.mock.Mock, mock_url: unittest.mock.Mock
    ) -> None:
        mock_url.return_value = True
    ...
    @patch("app.main.valid_google_url")
    @patch("app.main.has_internet_connection")
    def test_invalid_url_and_internet_available(
        self, mock_int: unittest.mock.Mock, mock_url: unittest.mock.Mock
    ) -> None:
    ...
    @patch("app.main.valid_google_url")
    @patch("app.main.has_internet_connection")
    def test_invalid_url_and_internet_not_available(
        self, mock_int: unittest.mock.Mock, mock_url: unittest.mock.Mock
    ) -> None:
        mock_url.return_value = False
        mock_int.return_value = False
