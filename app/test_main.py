...
def test_func_usage_valid_google(mocked_valid_google_url):
    can_access_google_page("https://www.google.com")
    mocked_valid_google_url.assert_called_once()

def test_func_usage_has_internet_connection(mocked_has_internet_connection):
    can_access_google_page("https://www.google.com")
    mocked_has_internet_connection.assert_called_once()

def test_main_func_access(mocked_valid_google_url, mocked_has_internet_connection):
    mocked_valid_google_url.return_value = True
    mocked_has_internet_connection.return_value = True
    assert can_access_google_page("https://www.google.com") == "Accessible"

def test_main_func_not_access(mocked_valid_google_url, mocked_has_internet_connection):
