...
@pytest.mark.parametrize("internet_connection, valid_url, expected_result", [
    ...
    (False, True, "The Google page is not accessible due to lack of internet connection."),
    (True, False, "The provided URL is not a valid Google URL."),
    (False, False, "The Google page is not accessible due to lack of internet connection and the provided URL is not a valid Google URL.")
])
def test_can_access_google_page(internet_connection: bool, valid_url: bool, expected_result: str) -> None:
    with (
