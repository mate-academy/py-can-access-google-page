...
def test_google_page_true(mocked_google_url: str, mocked_internet_connection: bool):
    mocked_google_url.return_value = True
    mocked_internet_connection.return_value = True
    assert can_access_google_page("www.mataacademy.com") == "Accessible"


def test_google_page_false_google_url(mocked_google_url: str,
...
def test_google_page_false_internet_connection(mocked_google_url: str,
                                               mocked_internet_connection: bool):
    mocked_google_url.return_value = True
