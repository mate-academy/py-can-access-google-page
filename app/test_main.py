...
def test_return_not_accessible_if_internet_is_false(mocked_internet, mocked_valid_url):
...
def test_return_not_accessible_if_url_is_false(mocked_internet, mocked_valid_url):
    mocked_internet.return_value = True
