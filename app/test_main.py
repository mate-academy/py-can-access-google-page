...
def test_can_access_google_page_with_valid_url_and_no_internet_connection(
) -> None:
...
def test_can_access_google_page_with_invalid_url_and_internet_connection(
) -> None:
    with patch("app.main.has_internet_connection", return_value=True), \
...
def test_can_access_google_page_with_invalid_url_and_no_internet_connection(
) -> None:
    with patch("app.main.has_internet_connection", return_value=False), \
         patch("app.main.valid_google_url", return_value=False):
        result = can_access_google_page("https://invalid-url.com")
