...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            lambda url: True, lambda: False,
            id="No Internet"
        ),
        pytest.param(
            "", "Not accessible",
            lambda url: False, lambda: True,
            id="Invalid URL"
        ),
        pytest.param(
            "https://google.com", "Accessible",
            lambda url: True, lambda: True,
            id="Access Google"
        ),
        pytest.param(
...
def test_can_access_google_page(monkeypatch, url, expected, mock_valid, mock_internet):
