...
@pytest.mark.parametrize(
    "valid_google_url_return_value, has_internet_connection_return_value, result",
    [
...
def test_can_access_google_page_accessible(
    ...
    mocked_has_internet_connection.return_value = has_internet_connection_return_value
