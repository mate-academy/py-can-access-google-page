...
@pytest.fixture()
def test_can_access_google_page_when_url_valid_and_connection_exists() -> None:
...
def test_cannot_access_if_only_valid_url(mocked_valid_google_url: mock.MagicMock,
                                         mocked_internet_connection: mock.MagicMock
                                         ) -> None:
    mocked_valid_google_url.return_value = True
...
def test_cannot_access_if_only_connection(mocked_valid_google_url: mock.MagicMock,
                                          mocked_internet_connection: mock.MagicMock
                                          ) -> None:
