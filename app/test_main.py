...
def test_can_access_google_page(has_connection: mock.MagicMock, valid_url: mock.MagicMock):
...
def test_valid_google_url(input_of_expected_url: str, expected_result: bool) -> None:
...
def test_exceptions_valid_google_url(argument:Any, expected_error):
