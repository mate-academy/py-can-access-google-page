...
def test_cannot_access_if_connection_or_valid_url_is_true(mocked_internet_connection, mocked_valid_url):
...
def test_cannot_access_if_only_connection(mocked_internet_connection, mocked_valid_url):
    mocked_valid_url.return_value = False
    mocked_internet_connection.return_value = True
    assert can_access_google_page("") == "Not accessible"


def test_cannot_access_if_only_valid_url(mocked_internet_connection, mocked_valid_url):
