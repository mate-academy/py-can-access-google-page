...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(True, True, "Accessible", id="test_if_two_dependencies_are_True"),
        pytest.param(True, False, "Not accessible", id="test_cannot_access_if_only_url"),
        pytest.param(False, True, "Not accessible", id="test_cannot_access_if_only_connection"),
        pytest.param(False, False, "Not accessible", id="test_if_two_dependencies_are_False")
    ]
)
@mock.patch("app.main.has_internet_connection")
@mock.patch("app.main.valid_google_url")
def test_can_access_google_page(mocked_valid_google_url2: MagicMock,
                                ...
                                valid_google_url_return: bool, has_internet_connection_return: bool,
