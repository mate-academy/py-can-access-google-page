...
def test_can_access_page(mocked_valid_url, mocked_internet) -> None:
...
@mock.patch("app.main.valid_google_url")
@mock.patch("app.main.has_internet_connection")
def test_invalid_url(mocked_valid_url, mocked_internet) -> None:
...
@mock.patch("app.main.valid_google_url")
@mock.patch("app.main.has_internet_connection")
def test_no_connection(mocked_valid_url, mocked_internet) -> None:
    mocked_valid_url.return_value = True
