...
@pytest.mark.parametrize(
    "valid_google_url_parametr,has_internet_connection_parametr,expected",
    [
...
def test_can_access_google_page(
        ...
        valid_google_url_parametr: bool,
        has_internet_connection_parametr: bool,
        expected: str
) -> None:
    valid_google_url.return_value = valid_google_url_parametr
    has_internet_connection.return_value = has_internet_connection_parametr
