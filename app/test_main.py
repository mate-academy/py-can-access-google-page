...
@pytest.mark.parametrize(
    ...
    ids=[
        ...
        "Should not be Accessible when neither url is valid nor connection is present",
...
def test_can_access_google_page(
    ...
    with mock.patch("app.main.valid_google_url") as mocked_url_check, mock.patch(
            "app.main.has_internet_connection") as mocked_internet_check:
