...
def test_valid_url_and_has_connection(mocked_google_url,
...
def test_valid_url_and_no_connection(mocked_google_url,
                                     mocked_internet_connection):
    mocked_google_url.return_value = True
...
def test_wrong_url_and_has_connection(mocked_google_url,
                                      mocked_internet_connection):
...
def test_wrong_url_and_no_connection(mocked_google_url,
                                     mocked_internet_connection):
    mocked_google_url.return_value = False
    mocked_internet_connection.return_value = False
